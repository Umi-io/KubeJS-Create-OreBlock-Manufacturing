...
ServerEvents.recipes(r => {
    ...
    function ingotToNuggets(material) {
        r.shapeless(Item.of(k(`${material}_nugget`), 9), Item.of(k(`${material}_ingot`), 1))
            .id(k(`${material}_ingot_to_${material}_nuggets`));
    }

    function ingotsToBlock(material) {
        r.shaped(k(`${material}_block`, 1), [
            'MMM',
            'MMM',
            'MMM'
        ], {
    ...
    function blockToIngots(material) {
        r.shapeless(Item.of(k(`${material}_ingot`, 9)), Item.of(k(`${material}_block`), 1))
    ...
    if (global.ingots) {
        ...
        console.error("global.ingots is not defined");
    }
});
